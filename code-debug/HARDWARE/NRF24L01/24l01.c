...
{  
	...
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOA|RCC_AHB1Periph_GPIOC, ENABLE);//使能GPIOB,G时钟
...
u8 NRF24L01_TxPacket_Task(u8 *txbuf)
{
	u8 sta;
     NrfMode = TxMode;
